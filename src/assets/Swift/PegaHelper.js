...
function InvokeAdvisor() {
  ...
  PegaAParamObject.channelId="bot57fe0bc1e1a549e3aa93dde4b891af99";
  if( window && window.localStorage && window.localStorage.length>0){
    ...
    PegaAParamObject.loggedInUser = parent.localStorage.userName;
    PegaAParamObject.CifNbr = parent.localStorage.CifNbr;
    }
