...
//  userAttributes: any[] = UserAttributeType[];
 userAttributes: UserAttributeType[] = [];
...
// UserAttributes;
  ...
  public createUserAttributeObject(name: string , value: any): UserAttributeType {
    const attr = {} as UserAttributeType;
    attr.name = name;
    attr.value = value;
